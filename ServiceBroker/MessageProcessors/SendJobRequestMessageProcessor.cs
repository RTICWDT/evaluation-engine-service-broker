// -----------------------------------------------------------------------
// <copyright file="SendJobRequestMessageProcessor.cs" company="RTI">
...
namespace ServiceBroker.MessageProcessors
{
    ...
    /// </summary>
    public class SendJobRequestMessageProcessor
    {
        /// <summary>
        /// The logger
        /// </summary>
        ...
        public static void ProcessMessage(byte[] message)
        {
            ...
            var classMessage = JsonConvert.DeserializeObject<JobRequestMessage>(stringMessage);
